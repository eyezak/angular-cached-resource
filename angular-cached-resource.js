...
module.exports = function(providerParams) {
  ...
  return ResourceCacheEntry = (function() {
    ...
    ResourceCacheEntry.prototype.set = function(value, dirty, merge) {
      this.value = merge != null ? merge : {
        value: angular.merge(value, this.value)
      };
      this.dirty = dirty;
      return this._update();
    };
    ...
    if (isArray) {
      ...
      for (i = 0, len = data.length; i < len; i++) {
        ...
        if (!angular.equals(cacheEntry.data, resource)) {
          cacheEntry.set(resource, isDirty, true);
        }
      }
    } else {
